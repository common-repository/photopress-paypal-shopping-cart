...
Tags: photos, images, taxonomies, e-commerce, shopping carts, print sales, selling prints, selling photos, print ordering
...
For more information on ways to use PhotoPress and other plugins to build a photography website check out the [WordPress For Photographers e-Book](http://wpphotog.com/product/the-guide-to-wordpress-for-photographers/ "WordPress For Photographers").
